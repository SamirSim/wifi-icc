...
NS_LOG_COMPONENT_DEFINE ("script-stochastic");
...
int main (int argc, char *argv[]) {
  ...
  double totalSentPackets = (((std::stof(dataRate) * 1024 * 1024 / 8) / payloadSize) * simulationTime ) * nWifi; // Estimation of number of generated packets in the network
